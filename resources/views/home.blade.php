    ...
    <div>
        ...
        <div class="flex flex-col h-full justify-center mt-[calc(33%-6rem)]"> <!-- 親要素に flex と mt- を追加 -->
            ...
            <div class="mt-4 text-center">
                ...
                <div class="mt-10">
                    {{-- 10.10.22.33修正 --}}
                    <a href="/skyway2" class="h-14 w-40 shadow-lg bg-green-500 hover:bg-green-600 shadow-green-500/50 hover:shadow-green-600/50 text-white rounded px-2 py-1 transition duration-300 ease-in-out">
    検査を受託する
</a>
